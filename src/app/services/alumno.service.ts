...
export class AlumnoService {
  ...
  constructor() { }
  listAlumno:Alumno[]=[
    {codigo:1 ,nombres: "Jose", apellidos: "Ramirez", correo: "joseas@asda.com", estado: "Aprobado", telefono: 93453364},
    {codigo:2 ,nombres: "Maria ", apellidos: "Guzman", correo: "mariasd@asd.was", estado: "Aprobado", telefono: 91375784},
    {codigo:3 ,nombres: "Juana ", apellidos: "Rojas", correo: "juwnneas@sdfe.de", estado: "Desaprobado", telefono: 97845344},
    {codigo:4 ,nombres: "Katherine ", apellidos: "Ponce ", correo: "kenasdkk@asdasd.ew", estado: "Aprobado", telefono: 9745384},
    {codigo:5 ,nombres: "Cesar", apellidos: " Rodríguez ", correo: "wewad@sadas.ea", estado: "Desaprobado", telefono: 9778684}
  ];
...
/*   agregarAlumno(Alumno: Alumno) {
  ...
  addAlumno(alumno:Alumno){
    ...
    alumno.codigo= ++this.cantAlumnos
